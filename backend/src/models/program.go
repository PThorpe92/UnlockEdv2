...
type Program struct {
	...
	ProgramType   string `json:"program_type" gorm:"not null" validate:"required,max=255"`
	ProgramStatus string `json:"program_status" gorm:"not null" validate:"required,max=255"`
